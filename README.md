...
3. 분위기·브랜드·가독성 추천 3안을 비교합니다.
4. 상품·콘텐츠는 이미지 하단, 배너는 왼쪽 연결부 기반 결과를 확인합니다.
5. 필요한 브랜드 역할색을 잠그고 대비 매트릭스와 신뢰도를 검토합니다.
6. 배치 화면에서 예외만 검수한 뒤 **CSS 복사** 또는 **프로젝트 JSON**으로 내보냅니다.
...
| 복원 버전 | 이미지 중복 없이 팔레트·설정 최근 5개 저장·복원 |
